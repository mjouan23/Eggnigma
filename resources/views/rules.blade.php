...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        ...
        <ul class="list-unstyled mt-3">
            <li class="mb-3"><strong>1.</strong> Trouve les œufs dans le jardin ou la maison.</li>
            <li class="mb-3"><strong>2.</strong> Scanne le QR Code sur l'œuf.</li>
            <li class="mb-3"><strong>3.</strong> Réponds à l'énigme affichée dans l'application.</li>
            <li class="mb-3"><strong>4.</strong> Si la réponse est correcte, l'énigme est marquée comme résolue.</li>
        </ul>

        <h2 class="h5 mt-4">Conseils</h2>
        <p>Les énigmes peuvent contenir des indices optionnels. Clique sur <strong>Afficher l'indice</strong> si tu en as besoin.</p>

        <h2 class="h5 mt-4">À noter</h2>
